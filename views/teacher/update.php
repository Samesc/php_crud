...
$result = mysqli_query($conn,"SELECT * FROM teacher WHERE idteacher='" . $_GET['id'] . "'");
$row= mysqli_fetch_array($result);
$birthdate = date('Y-m-d', $row["birthdate"]);
?>

<div class="container jumbotron">
    <h2>Actualización de maestros</h2>
    <form id="sendDatafrom">
        ...
        <div class="lead">
            ...
            <input type="button" class="btn btn-primary" id="sendStudentData"  data-toggle="modal" data-target="#messageModal" onclick="sendData()" value="Actualizar">
       </div>
    </form>
</div>
